...
describe("PLANNER_MEMO_SYSTEM_PROMPT", () => {
  it("contains key mobile web-fiction craft phrases", () => {
    ...
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("JSON 对象");
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("\"goal\"");
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("\"threadRefs\"");
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("不超过 50 字");
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("\"currentTask\"");
    expect(PLANNER_MEMO_SYSTEM_PROMPT).toContain("\"doNot\"");
  });
