...
export { buildSkillGuidanceText } from "./agent/agent-system-prompt.js";
export {
  BUILTIN_PROMPTS,
...
export { IndexDB, type IndexedChapter, type IndexedForeshadowing, type IndexedCharacter, type BookSummary } from "./state/index-db.js";
...
export {
  seedProjectBuiltinMaterials,
  BUILTIN_SEED_MARKER,
  type SeededMaterialResult,
} from "./materials/seed.js";
