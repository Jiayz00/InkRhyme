...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@inkrhyme/core/interactive-film/evaluator": resolve(__dirname, "../core/src/interactive-film/evaluator.ts"),
      "@inkrhyme/core/interactive-film/graph-schema": resolve(__dirname, "../core/src/interactive-film/graph-schema.ts"),
      "@inkrhyme/core/forecast/schema": resolve(__dirname, "../core/src/forecast/schema.ts"),
      "@inkrhyme/core/agents/builtin-names": resolve(__dirname, "../core/src/agents/builtin-names.ts"),
      "@inkrhyme/core/workflow": resolve(__dirname, "../core/src/workflow.ts"),
