...
function parseHash(hash: string): HashRoute {
  ...
  if (path === "automation") return { page: "automation" };
...
const HASH_PAGES = new Set(["dashboard", "chat", "book", "book-settings", "book-create", "services", "project-settings", "service-detail", "translation", "import", "play", "film", "flow", "film-author", "film-studio", "automation"]);
